...
// NoLoneBlocksOptions defines the configuration options for this rule
type NoLoneBlocksOptions struct {
...
func parseOptions(options any) NoLoneBlocksOptions {
	opts := NoLoneBlocksOptions{
