...
// PreferRegexLiteralsOptions defines the configuration options for this rule
...
func parseOptions(options any) PreferRegexLiteralsOptions {
	opts := PreferRegexLiteralsOptions{
...
// PreferRegexLiteralsRule implements the prefer-regex-literals rule
