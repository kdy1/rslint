...
// MaxDepthOptions defines the configuration options for this rule
type MaxDepthOptions struct {
...
func parseOptions(options any) MaxDepthOptions {
	opts := MaxDepthOptions{
...
// MaxDepthRule implements the max-depth rule
