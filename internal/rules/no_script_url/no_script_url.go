...
// NoScriptUrlOptions defines the configuration options for this rule
type NoScriptUrlOptions struct {
...
func parseOptions(options any) NoScriptUrlOptions {
	opts := NoScriptUrlOptions{
...
// NoScriptUrlRule implements the no-script-url rule
