...
// LogicalAssignmentOperatorsOptions defines the configuration options for this rule
...
func parseOptions(options any) LogicalAssignmentOperatorsOptions {
	opts := LogicalAssignmentOperatorsOptions{
...
// LogicalAssignmentOperatorsRule implements the logical-assignment-operators rule
