...
// MaxStatementsOptions defines the configuration options for this rule
type MaxStatementsOptions struct {
...
func parseOptions(options any) MaxStatementsOptions {
	opts := MaxStatementsOptions{
...
// MaxStatementsRule implements the max-statements rule
