...
// NoUndefinedOptions defines the configuration options for this rule
type NoUndefinedOptions struct {
...
func parseOptions(options any) NoUndefinedOptions {
	opts := NoUndefinedOptions{
...
// NoUndefinedRule implements the no-undefined rule
