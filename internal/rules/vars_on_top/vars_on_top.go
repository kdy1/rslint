...
// VarsOnTopOptions defines the configuration options for this rule
type VarsOnTopOptions struct {
...
func parseOptions(options any) VarsOnTopOptions {
	opts := VarsOnTopOptions{
...
// VarsOnTopRule implements the vars-on-top rule
