...
// NoEqNullOptions defines the configuration options for this rule
type NoEqNullOptions struct {
...
func parseOptions(options any) NoEqNullOptions {
	opts := NoEqNullOptions{
...
// NoEqNullRule implements the no-eq-null rule
