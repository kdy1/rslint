...
// PreferObjectHasOwnOptions defines the configuration options for this rule
type PreferObjectHasOwnOptions struct {
...
func parseOptions(options any) PreferObjectHasOwnOptions {
	opts := PreferObjectHasOwnOptions{
...
// PreferObjectHasOwnRule implements the prefer-object-has-own rule
