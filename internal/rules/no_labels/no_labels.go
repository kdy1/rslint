...
// NoLabelsOptions defines the configuration options for this rule
...
func parseOptions(options any) NoLabelsOptions {
	opts := NoLabelsOptions{
...
// NoLabelsRule implements the no-labels rule
