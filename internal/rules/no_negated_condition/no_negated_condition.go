...
// NoNegatedConditionOptions defines the configuration options for this rule
type NoNegatedConditionOptions struct {
...
func parseOptions(options any) NoNegatedConditionOptions {
	opts := NoNegatedConditionOptions{
...
// NoNegatedConditionRule implements the no-negated-condition rule
