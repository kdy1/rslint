...
// NoUnneededTernaryOptions defines the configuration options for this rule
...
func parseOptions(options any) NoUnneededTernaryOptions {
	opts := NoUnneededTernaryOptions{
...
// NoUnneededTernaryRule implements the no-unneeded-ternary rule
