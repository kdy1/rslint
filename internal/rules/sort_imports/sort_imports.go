...
// SortImportsOptions defines the configuration options for this rule
type SortImportsOptions struct {
...
func parseOptions(options any) SortImportsOptions {
	opts := SortImportsOptions{
...
// SortImportsRule implements the sort-imports rule
