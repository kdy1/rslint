...
// NoArrayConstructorOptions defines the configuration options for this rule
type NoArrayConstructorOptions struct {
...
func parseOptions(options any) NoArrayConstructorOptions {
	opts := NoArrayConstructorOptions{
