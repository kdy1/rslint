...
// IdDenylistOptions defines the configuration options for this rule
type IdDenylistOptions struct {
...
func parseOptions(options any) IdDenylistOptions {
	opts := IdDenylistOptions{
...
// IdDenylistRule implements the id-denylist rule
