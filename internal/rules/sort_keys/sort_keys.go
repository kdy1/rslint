...
// SortKeysOptions defines the configuration options for this rule
type SortKeysOptions struct {
...
func parseOptions(options any) SortKeysOptions {
	opts := SortKeysOptions{
...
// SortKeysRule implements the sort-keys rule
