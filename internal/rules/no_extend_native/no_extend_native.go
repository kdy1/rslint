...
// NoExtendNativeOptions defines the configuration options for this rule
...
func parseOptions(options any) NoExtendNativeOptions {
	opts := NoExtendNativeOptions{
...
// NoExtendNativeRule implements the no-extend-native rule
