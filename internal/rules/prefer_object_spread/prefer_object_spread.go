...
// PreferObjectSpreadOptions defines the configuration options for this rule
type PreferObjectSpreadOptions struct {
...
func parseOptions(options any) PreferObjectSpreadOptions {
	opts := PreferObjectSpreadOptions{
...
// PreferObjectSpreadRule implements the prefer-object-spread rule
