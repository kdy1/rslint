...
// SortVarsOptions defines the configuration options for this rule
type SortVarsOptions struct {
...
func parseOptions(options any) SortVarsOptions {
	opts := SortVarsOptions{
...
// SortVarsRule implements the sort-vars rule
