...
// RequireYieldOptions defines the configuration options for this rule
type RequireYieldOptions struct {
...
func parseOptions(options any) RequireYieldOptions {
	opts := RequireYieldOptions{
...
// RequireYieldRule implements the require-yield rule
