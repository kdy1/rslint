...
// GroupedAccessorPairsOptions defines the configuration options for this rule
...
func parseOptions(options any) GroupedAccessorPairsOptions {
	opts := GroupedAccessorPairsOptions{
...
// GroupedAccessorPairsRule implements the grouped-accessor-pairs rule
