...
// DefaultCaseOptions defines the configuration options for this rule
...
func parseOptions(options any) DefaultCaseOptions {
...
// DefaultCaseRule implements the default-case rule
