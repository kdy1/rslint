...
// NoObjectConstructorOptions defines the configuration options for this rule
type NoObjectConstructorOptions struct {
...
func parseOptions(options any) NoObjectConstructorOptions {
	opts := NoObjectConstructorOptions{
...
// NoObjectConstructorRule implements the no-object-constructor rule
