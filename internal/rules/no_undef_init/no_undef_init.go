...
// NoUndefInitOptions defines the configuration options for this rule
type NoUndefInitOptions struct {
...
func parseOptions(options any) NoUndefInitOptions {
	opts := NoUndefInitOptions{
...
// NoUndefInitRule implements the no-undef-init rule
