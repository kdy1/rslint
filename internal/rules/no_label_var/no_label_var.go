...
// NoLabelVarOptions defines the configuration options for this rule
type NoLabelVarOptions struct {
...
func parseOptions(options any) NoLabelVarOptions {
	opts := NoLabelVarOptions{
...
// NoLabelVarRule implements the no-label-var rule
