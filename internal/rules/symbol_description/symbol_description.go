...
// SymbolDescriptionOptions defines the configuration options for this rule
type SymbolDescriptionOptions struct {
...
func parseOptions(options any) SymbolDescriptionOptions {
	opts := SymbolDescriptionOptions{
...
// SymbolDescriptionRule implements the symbol-description rule
