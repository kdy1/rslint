...
// NoOctalEscapeOptions defines the configuration options for this rule
type NoOctalEscapeOptions struct {
...
func parseOptions(options any) NoOctalEscapeOptions {
	opts := NoOctalEscapeOptions{
...
// NoOctalEscapeRule implements the no-octal-escape rule
