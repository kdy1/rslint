...
// NoRestrictedExportsOptions defines the configuration options for this rule
...
func parseOptions(options any) NoRestrictedExportsOptions {
	opts := NoRestrictedExportsOptions{
...
// NoRestrictedExportsRule implements the no-restricted-exports rule
