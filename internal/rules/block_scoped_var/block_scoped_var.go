...
// BlockScopedVarOptions defines the configuration options for this rule
type BlockScopedVarOptions struct {
...
func parseOptions(options any) BlockScopedVarOptions {
	opts := BlockScopedVarOptions{
...
// BlockScopedVarRule implements the block-scoped-var rule
