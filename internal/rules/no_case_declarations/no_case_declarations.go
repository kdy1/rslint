...
// NoCaseDeclarationsOptions defines the configuration options for this rule
type NoCaseDeclarationsOptions struct {
...
func parseOptions(options any) NoCaseDeclarationsOptions {
	opts := NoCaseDeclarationsOptions{
