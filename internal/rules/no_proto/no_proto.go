...
// NoProtoOptions defines the configuration options for this rule
type NoProtoOptions struct {
...
func parseOptions(options any) NoProtoOptions {
	opts := NoProtoOptions{
...
// NoProtoRule implements the no-proto rule
