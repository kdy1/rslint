...
// OperatorAssignmentOptions defines the configuration options for this rule
...
func parseOptions(options any) OperatorAssignmentOptions {
	opts := OperatorAssignmentOptions{
...
// OperatorAssignmentRule implements the operator-assignment rule
