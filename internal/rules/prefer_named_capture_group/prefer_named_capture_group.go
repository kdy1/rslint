...
// PreferNamedCaptureGroupOptions defines the configuration options for this rule
type PreferNamedCaptureGroupOptions struct {
...
func parseOptions(options any) PreferNamedCaptureGroupOptions {
	opts := PreferNamedCaptureGroupOptions{
...
// PreferNamedCaptureGroupRule implements the prefer-named-capture-group rule
