...
// NoMultiStrOptions defines the configuration options for this rule
type NoMultiStrOptions struct {
...
func parseOptions(options any) NoMultiStrOptions {
	opts := NoMultiStrOptions{
