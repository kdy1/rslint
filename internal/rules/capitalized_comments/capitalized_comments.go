...
// CapitalizedCommentsOptions defines the configuration options for this rule
type CapitalizedCommentsOptions struct {
...
func parseOptions(options any) CapitalizedCommentsOptions {
	opts := CapitalizedCommentsOptions{
...
// CapitalizedCommentsRule implements the capitalized-comments rule
