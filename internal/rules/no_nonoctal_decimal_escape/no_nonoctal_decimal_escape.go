...
// NoNonoctalDecimalEscapeOptions defines the configuration options for this rule
type NoNonoctalDecimalEscapeOptions struct {
...
func parseOptions(options any) NoNonoctalDecimalEscapeOptions {
	opts := NoNonoctalDecimalEscapeOptions{
...
// NoNonoctalDecimalEscapeRule implements the no-nonoctal-decimal-escape rule
