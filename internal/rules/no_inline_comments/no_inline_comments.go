...
// NoInlineCommentsOptions defines the configuration options for this rule
...
func parseOptions(options any) NoInlineCommentsOptions {
	opts := NoInlineCommentsOptions{
...
// NoInlineCommentsRule implements the no-inline-comments rule
