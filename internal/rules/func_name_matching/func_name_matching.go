...
// FuncNameMatchingOptions defines the configuration options for this rule
...
func parseOptions(options any) FuncNameMatchingOptions {
	opts := FuncNameMatchingOptions{
...
// FuncNameMatchingRule implements the func-name-matching rule
