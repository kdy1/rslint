...
// PreferExponentiationOperatorOptions defines the configuration options for this rule
type PreferExponentiationOperatorOptions struct {
...
func parseOptions(options any) PreferExponentiationOperatorOptions {
	opts := PreferExponentiationOperatorOptions{
...
// PreferExponentiationOperatorRule implements the prefer-exponentiation-operator rule
