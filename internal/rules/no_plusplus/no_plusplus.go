...
// NoPlusplusOptions defines the configuration options for this rule
...
func parseOptions(options any) NoPlusplusOptions {
	opts := NoPlusplusOptions{
...
// NoPlusplusRule implements the no-plusplus rule
