...
// NoImplicitCoercionOptions defines the configuration options for this rule
...
func parseOptions(options any) NoImplicitCoercionOptions {
	opts := NoImplicitCoercionOptions{
...
// NoImplicitCoercionRule implements the no-implicit-coercion rule
