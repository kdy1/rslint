...
// NoOctalOptions defines the configuration options for this rule
type NoOctalOptions struct {
...
func parseOptions(options any) NoOctalOptions {
	opts := NoOctalOptions{
...
// NoOctalRule implements the no-octal rule
