...
// NoNewWrappersOptions defines the configuration options for this rule
type NoNewWrappersOptions struct {
...
func parseOptions(options any) NoNewWrappersOptions {
	opts := NoNewWrappersOptions{
...
// NoNewWrappersRule implements the no-new-wrappers rule
