...
// NoContinueOptions defines the configuration options for this rule
type NoContinueOptions struct {
...
func parseOptions(options any) NoContinueOptions {
	opts := NoContinueOptions{
...
// NoContinueRule implements the no-continue rule
