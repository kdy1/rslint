...
// NoParamReassignOptions defines the configuration options for this rule
...
func parseOptions(options any) NoParamReassignOptions {
...
// NoParamReassignRule implements the no-param-reassign rule
