...
// NoDivRegexOptions defines the configuration options for this rule
type NoDivRegexOptions struct {
...
func parseOptions(options any) NoDivRegexOptions {
	opts := NoDivRegexOptions{
...
// NoDivRegexRule implements the no-div-regex rule
