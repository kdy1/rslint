...
// NoUselessComputedKeyOptions defines the configuration options for this rule
type NoUselessComputedKeyOptions struct {
...
func parseOptions(options any) NoUselessComputedKeyOptions {
	opts := NoUselessComputedKeyOptions{
...
// NoUselessComputedKeyRule implements the no-useless-computed-key rule
