...
// NoDeleteVarOptions defines the configuration options for this rule
type NoDeleteVarOptions struct {
...
func parseOptions(options any) NoDeleteVarOptions {
	opts := NoDeleteVarOptions{
