...
// NoIteratorOptions defines the configuration options for this rule
type NoIteratorOptions struct {
...
func parseOptions(options any) NoIteratorOptions {
	opts := NoIteratorOptions{
...
// NoIteratorRule implements the no-iterator rule
