...
// NoShadowRestrictedNamesOptions defines the configuration options for this rule
...
func parseOptions(options any) NoShadowRestrictedNamesOptions {
	opts := NoShadowRestrictedNamesOptions{
...
// NoShadowRestrictedNamesRule implements the no-shadow-restricted-names rule
