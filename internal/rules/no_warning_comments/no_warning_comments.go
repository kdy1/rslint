...
// NoWarningCommentsOptions defines the configuration options for this rule
...
func parseOptions(options any) NoWarningCommentsOptions {
	opts := NoWarningCommentsOptions{
...
// NoWarningCommentsRule implements the no-warning-comments rule
