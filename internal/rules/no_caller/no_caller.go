...
// NoCallerOptions defines the configuration options for this rule
type NoCallerOptions struct {
...
func parseOptions(options any) NoCallerOptions {
	opts := NoCallerOptions{
