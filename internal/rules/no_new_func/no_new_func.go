...
// NoNewFuncOptions defines the configuration options for this rule
type NoNewFuncOptions struct {
...
func parseOptions(options any) NoNewFuncOptions {
	opts := NoNewFuncOptions{
...
// NoNewFuncRule implements the no-new-func rule
